...
from operate_system import task, asyncTask, pool
...
def process():
    time.sleep(1)
    print('This is a callable SimpleTask function 1.')
    time.sleep(1)
    print('This is a callable SimpleTask function 2.')
...
def test_async_task():
    ...
    # 2.生成一系列的任务
    for i in range(10):
        async_task = asyncTask.AsyncTask(func=async_process)
        # 3.往线程池提交任务执行
